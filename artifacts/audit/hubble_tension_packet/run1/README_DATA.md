# Hubble Tension Evidence Packet v0.2
...
E(z) residuals are computed using a lowest-z anchor from the dataset (policy: lowest_z_anchor).
...
## Reproduction
python tools/build_hubble_tension_packet.py --outdir artifacts/evidence_hubble_tension_v0_2
